# Shape Index Solidbench Experiment with Comunica where 50% of the shape index entries are closed shapes 

Experiments to benchmark solid bench queries using the shape index approach, where 50% of the shape index entries are closed shapes.
